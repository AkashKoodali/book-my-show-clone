...
function PaymentModel({setIsOpen, isOpen, price}) {
    ...
    const launchRazorPay = () => {
        let options = {
            ...
            image: "https://res.cloudinary.com/crunchbase-production/image/upload/c_lpad,f_auto,q_auto:eco,dpr_1/v1490416068/snddxyieomgp4s7sj7bp.png",
            handler: () => {
                setIsOpen(false);
